...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Okt 2021 pada 14.21
...
--
-- Dumping data untuk tabel `hasil_lps`
--
...
--
-- Struktur dari tabel `hasil_lps_guru`
--
...
--
-- Dumping data untuk tabel `hasil_lps_guru`
--
...
--
-- Struktur dari tabel `pertanyaan_lps`
--
...
--
-- Dumping data untuk tabel `pertanyaan_lps`
--
...
--
-- Indeks untuk tabel `hasil_lps`
--
ALTER TABLE `hasil_lps`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `hasil_lps_guru`
--
...
--
-- Indeks untuk tabel `pertanyaan_lps`
--
...
--
-- AUTO_INCREMENT untuk tabel `hasil_lps`
--
ALTER TABLE `hasil_lps`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;

--
-- AUTO_INCREMENT untuk tabel `hasil_lps_guru`
--
ALTER TABLE `hasil_lps_guru`
...
--
-- AUTO_INCREMENT untuk tabel `pertanyaan_lps`
--
ALTER TABLE `pertanyaan_lps`
